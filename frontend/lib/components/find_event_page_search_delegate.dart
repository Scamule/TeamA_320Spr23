...
class FindEventPageSearchDelegate extends SearchDelegate {
    ...
    return FutureBuilder(
      ...
      builder: (context, snapshot) {
        if (snapshot.connectionState == ConnectionState.done) {
          ...
          // Display a loading indicator while waiting for the results
          return const Center(
  ...
  Widget buildSuggestions(BuildContext context) {
    ...
    return FutureBuilder(
      ...
      builder: (context, snapshot) {
        ...
        // Display a loading indicator while waiting for the suggestions
        return const Center(
          child: CircularProgressIndicator(),
        );
      },
  ...
  void close(BuildContext context, result) {
    // Call onClosed function before closing the search delegate
    onClosed();
