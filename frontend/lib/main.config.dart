...
import 'package:uscheduler/view_models/home_viewmodel.dart' as _i4;
import 'package:uscheduler/view_models/login_viewmodel.dart' as _i7;
...
extension GetItInjectableX on _i1.GetIt {
  ...
  _i1.GetIt init({
    ...
    gh.singleton<_i4.HomeViewModel>(
        _i4.HomeViewModel(gh<_i3.EventsRepository>()));
    gh.singleton<_i5.SharedPreferencesRepo>(_i5.SharedPreferencesRepo());
    gh.singleton<_i6.UserRepository>(_i6.UserRepository());
    gh.singleton<_i7.LoginViewModel>(_i7.LoginViewModel(
      gh<_i5.SharedPreferencesRepo>(),
